...
task :remote_environment do
  ...
  invoke :'rvm:use', 'ruby-3.4.2@default'
end
...
task :deploy do
  ...
  deploy do
    ...
    command %{export PATH=/usr/local/rvm/gems/ruby-3.4.2/bin:$PATH}
    command %{export PATH=/usr/local/rvm/gems/ruby-3.4.2@global/bin:$PATH}
    command %{export PATH=:/usr/local/rvm/rubies/ruby-3.4.2/bin:$PATH}
