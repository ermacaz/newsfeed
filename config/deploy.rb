...
task :deploy do
  ...
  deploy do
    ...
    command %{export PATH=/usr/local/rvm/gems/ruby-3.3.2/bin:$PATH}
    command %{export PATH=/usr/local/rvm/gems/ruby-3.3.2@global/bin:$PATH}
    command %{export PATH=:/usr/local/rvm/rubies/ruby-3.3.2/bin:$PATH}
