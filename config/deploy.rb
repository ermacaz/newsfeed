...
set :application, "newsfeed"
set :repo_url, "git@github.com:ermacaz/newsfeed.git"
...
set :ssh_options,     { forward_agent: true, user: fetch(:user), keys: %w(/home/deploy/.ssh/id_ed25519.pub) }
